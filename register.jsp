...
<html lang="en">
  <head>
    ...
    <title>Register It Support</title>
	...
	<div class="container w-50 m-auto">
	  <form action="register" method="POST">
		...
		<div class="form-group">
		  ...
		  <input type="number" class="form-control" id="mobileno" placeholder="Enter mobile number" name="mobile" required>
		  <div class="invalid-feedback">Please enter mobile no.</div>
		</div>
		
		
		<div class="form-group">
			<label>Describe Problem<sup>&#9733;</sup></label>
			<textarea class="form-control" name="problem" required>
			</textarea>
			<span ><small>Please explain in detail</small>
			</span>
		</div>
